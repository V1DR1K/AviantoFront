...
export const metadata: Metadata = { title:"AviantoSoftware | Gestión de taller",description:"Órdenes de trabajo, presupuestos e historial para talleres de motos.", icons:{icon:"/brand/favicon.png"} };
