...
const whatsappUrl = "https://wa.me/5493412639357?text=Hola%2C%20quiero%20conocer%20Avianto";
  ...
  return (
    <main className="landing-page">
      <header className="landing-header">
          ...
          <BrandLogo variant="color" size="sm" descriptor />
        </a>
      ...
      <section className="landing-hero" id="inicio">
        <div className="landing-hero-copy">
          ...
          <p className="landing-note">Mecánica integral de motos, con información que queda.</p>
        </div>

        <div className="landing-hero-visual" aria-label="Ejemplo de una ficha de servicio de Avianto">
          <div className="landing-visual-caption">Vista de producto <span>Avianto</span></div>
      ...
      <section className="landing-cta" id="demo">
        <div>
          ...
          <p>Escribinos para conocer cómo Avianto conecta el ingreso de una moto con su orden de trabajo.</p>
        </div>
      ...
      <footer className="landing-footer">
        <a className="landing-brand" href="#inicio" aria-label="Avianto, volver al inicio"><BrandLogo variant="color" size="sm" descriptor /></a>
